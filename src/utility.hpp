...
"[(--cornerrow-blob)]\n"
"        Use corner-row contraction to test and contract edges in the binary\n"
...
"        Corner-row heavy-sampling multiplier: each row draws\n"
"        min(multiplier*k, row population) tuples instead of k (default: 1)\n"
"[(--corner-tau) <float number>]\n"
"        Corner-row contradiction threshold tau in (0,1)\n"
"        (default: (1+delta)/4 from --delta)\n"
"[(--corner-seed) <non-negative integer>]\n"
"        Private seed used to draw the corner-row samples (default: 20250729)\n"
"[(--delta) <float number>]\n"
